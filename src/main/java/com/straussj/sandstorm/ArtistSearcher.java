 ...
 */
public class ArtistSearcher extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArtistSearchRequest artistRequest = api.searchArtists(request.getParameter("Artist name")).market("US").limit(5).build();
		try {
