  ...
  private boolean _jspx_meth_c_005fif_005f1(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-warning\">Add this playlist to \n");
        out.write("\t\t\t\t\t\t\tyour Spotify account</button>\n");
        out.write("\t\t\t\t\t\t</form>\n");
        out.write("\t\t\t\t\t</div>\n");
        out.write("\t\t\t\t\t<div class=\"col-md-1\">\n");
        out.write("\t\t\t\t\t\t<p class=\"lead\">or</p>\n");
        out.write("\t\t\t\t\t</div>\n");
        out.write("\t\t\t\t\t<div class=\"col-md-2\">\n");
        out.write("\t\t\t\t\t\t<form method=\"post\" action=\"StartOver\">\n");
        out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-warning\">Start a new playlist</button>\n");
        out.write("\t\t\t\t\t\t</form>\n");
        out.write("\t\t\t\t\t</div>\n");
        out.write("\t\t\t\t</div>\n");
        out.write("\t\t\t</div>\n");
